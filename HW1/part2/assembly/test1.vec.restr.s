	...
	.p2align	3                               # -- Begin function _Z4testPfS_S_i
.LCPI0_0:
	.quad	0x3e112e0be826d695              # double 1.0000000000000001E-9
	.text
	.globl	_Z4testPfS_S_i
	.p2align	4, 0x90
	.type	_Z4testPfS_S_i,@function
...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	addps	%xmm0, %xmm2
	movups	48(%r15,%rcx,4), %xmm0
	addps	%xmm1, %xmm0
	movups	%xmm2, 32(%r14,%rcx,4)
	movups	%xmm0, 48(%r14,%rcx,4)
	addq	$16, %rcx
...
.LBB0_7:
	...
	callq	__assert_fail
.Lfunc_end0:
	.size	_Z4testPfS_S_i, .Lfunc_end0-_Z4testPfS_S_i
	.cfi_endproc
                                        # -- End function
...
.L__PRETTY_FUNCTION__._ZL7gettimev:
	...
	.ident	"Debian clang version 11.0.0-++20200928064302+eb83b551d3e-1~exp1~20200928164917.111"
